...
// ==================== WIFI ====================
const char* ssid = "WARKOP TERAS";
const char* pass = "upinipin";
const char* RUST_IP = "192.168.1.37";   // GANTI DENGAN IP PC KAMU!
...
// ==================== TIMING (ms) ====================
const unsigned long T_PRECOND  = 15000;
const unsigned long T_RAMP     = 2000;
const unsigned long T_HOLD     = 60000;
const unsigned long T_PURGE    = 120000;
const unsigned long T_RECOVERY = 15000;
